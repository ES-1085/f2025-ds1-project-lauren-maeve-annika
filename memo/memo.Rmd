...
ggplot(summary_long, aes(x = factor(HomeTeam, levels = team_order),
  ...
  coord_flip() +
  ylim(0, 25)
>>>>>>> fec7c627b19d61fa20de7a626ae0195d791a98c7
...
=======
Post meeting together, we weren't sure if the colors would be accessible enough for the audience so we chose a color blind friendly option.
